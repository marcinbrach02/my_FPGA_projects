...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n fifo_dc -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 1024 -width 8 -rwidth 8 -no_enable -pe 10 -pf 508  */
/* Sat Nov 23 15:53:38 2019 */


`timescale 1 ns / 1 ps
module fifo_dc (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_dc_0_0.FULLPOINTER1 = "0b01111111111000" ;
    defparam fifo_dc_0_0.FULLPOINTER = "0b10000000000000" ;
    defparam fifo_dc_0_0.AFPOINTER1 = "0b00111111011000" ;
    defparam fifo_dc_0_0.AFPOINTER = "0b00111111100000" ;
    defparam fifo_dc_0_0.AEPOINTER1 = "0b00000001011000" ;
    defparam fifo_dc_0_0.AEPOINTER = "0b00000001010000" ;
    ...
    defparam fifo_dc_0_0.DATA_WIDTH_R = 9 ;
    defparam fifo_dc_0_0.DATA_WIDTH_W = 9 ;
    FIFO8KB fifo_dc_0_0 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), .DI3(Data[3]), 
